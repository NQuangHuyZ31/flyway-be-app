...
class UpdateStockOutputVoucherRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'output_type' => 'sometimes|required|in:sale,return_to_supplier,transfer_out,adjustment,sample',
            'warehouse_id' => 'sometimes|required|exists:warehouses,id',
            'section_id' => 'nullable|exists:warehouse_sections,id',
            'customer_id' => 'nullable|exists:customers,id',
            'output_date' => 'sometimes|required|date',
